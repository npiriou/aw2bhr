 ...
 * contiguous block at 0x0805D1F0.
 * sub_0805D1F0 @ 0x0805D1F0
 */
 ...
 * ROM's gUnknown_0816DA30 / gUnknown_0816DA34 and the build now places them there
...
{{
    ...
    {{
        if (gUnitRecords[i].unk00 != 0
            ...
            && gUnitTypeData[gUnitRecords[i].unk00].unk1b == 6)
        {{
            *gUnknown_030046B0++ = i;
        }}
    }}
