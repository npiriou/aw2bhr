 ...
 * contiguous block at 0x0805CB1C.
 ...
 * ROM's gUnknown_0816D9E8 / gUnknown_0816D9EC and the build now places them there
...
{{
    ...
    {{
        if (gUnitRecords[i].unk00 != 0
            ...
            && gUnitTypeData[gUnitRecords[i].unk00].unk1b == 3)
        {{
            *gUnknown_030046B0++ = i;
        }}
    }}
    ...
    *gUnknown_030046B0 = 0;
    gUnknown_030046B0 = gUnknown_030045F0;
    gUnknown_03004778 = sub_0805DA84;
    gUnknown_03004780 = 2;
}}
