 ...
 * contiguous block at 0x0805D078.
 * sub_0805D078 @ 0x0805D078
 */
 ...
 * two words are the ROM's gUnknown_0816DA20 / gUnknown_0816DA24 and the build now
...
void sub_0805D078(void)
{
    ...
    for (i = gUnknown_03003F2C + 1; i < gUnknown_03003F2C + 0x40; i++)
    {
        if (gUnitRecords[i].unk00 != 0
            ...
            && gUnitTypeData[gUnitRecords[i].unk00].unk1b == 2)
        {
            *gUnknown_030046B0++ = i;
        }
    }
    ...
    *gUnknown_030046B0 = 0;
    ...
    gUnknown_03004778 = sub_0805DFB8;
    gUnknown_03004780 = 2;
}
